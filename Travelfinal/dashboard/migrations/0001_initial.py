    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[(1, 'HOD'), (2, 'MGR'), (3, 'OPE'), (4, 'Fin')], default=1, max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('passportcopy', models.FileField(blank=True, upload_to='project_images/')),
                ('Payslip', models.FileField(blank=True, upload_to='uploads/')),
